		...
		<div class="container">
			<div class="row">
				...
				<div class="col-lg-12">
					...
					try{
						$query= "SELECT * FROM active WHERE destination=:destination AND 
							...
							<div class="row">
								...
								<div class="col-lg-3 col-1680-4">
									<div class="offers_image_container">
										...
										<div class="offer_name"><a href="<?php echo APPURL;?>/detail/active.php?id=<?php echo $row['id'] ?>"><?php echo $row['title']; ?></a></div>
									</div>
								</div>
								<div class="col-lg-8">
